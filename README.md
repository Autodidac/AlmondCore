...
## Almond Core - The Heart of the AlmondEngine is a x64 Cross-platform OS Entry-Point System, Software Development Suite, and Game Engine Core with Data-Oriented, Functional/OOP Hybrid, Task and Event Driven Component based Architecture with built-in Stateless Scene Management, ECS, and Much More!
